...
//            This inspection analyzes method control and data flow to report possible conditions that are always true or false, expressions whose name is statically proven to be constant, and situations that can lead to nullability contract violations.
...
//                    @NotNull annotations (by default the ones from annotations.jar will be used)
            System.out.println(Objects.requireNonNull(TeacherFileDao.class.getClassLoader()
                    .getResource("falseData.json")).getFile().toString());
